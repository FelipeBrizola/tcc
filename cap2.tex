...
Os principais componentes deste trabalho são, além da implementação do protocolo em sí, o fato de que Spencer fazer uso de um \textit{middleware} que executa o gerenciamento dos recursos dos dispositivos \cite{Spencer:2015}.
