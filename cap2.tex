...
Essa técnica requer a existência de duas entidades, clientes e ao menos um \textit{message broker}.
...
Este ponto, o broker, faz com que o MQTT não seja um protocolo desentralizado, pois caso o broker fique inoperante toda a rede MQTT passa a ficar desatualizada.
